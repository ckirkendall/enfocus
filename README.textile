...
h3. Where to Start
Documentation on this readme is for the 2.x version.  Click "here":https://github.com/ckirkendall/enfocus/tree/1.x-branch to go to the readme for the 1.x release. 
...
"Hello world!" example above.  It comes in few basic flavors listed below:

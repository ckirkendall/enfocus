...
<pre>
  ...
  fade-in            (fade-in time)
                     ...
                     or (fade-in time callback accellerator)
  ...
  resize             (resize width height ttime)
                     ...
                     or (resize width height ttime callback accellerator)
  move               (move x y ttime)
                     or (move x y ttime callback)
                     or (move x y ttime callback accellerator)
